...
export class ExistingOracle implements StructClass { __StructClass = true as const;
 ...
 oracle_id: ID.bcs, oracle_key: bcs.vector(bcs.u8())

}) };

 static fromFields( fields: Record<string, any> ): ExistingOracle { return ExistingOracle.reified( ).new( { oracleId: decodeFromFields(ID.reified(), fields.oracle_id), oracleKey: decodeFromFields(reified.vector("u8"), fields.oracle_key) } ) }
 ...
 return ExistingOracle.reified( ).new( { oracleId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_id), oracleKey: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.oracle_key) } ) }
...
export class Queue implements StructClass { __StructClass = true as const;
 ...
 id: UID.bcs, queue_key: bcs.vector(bcs.u8()), authority: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), name: String.bcs, fee: bcs.u64(), fee_recipient: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), min_attestations: bcs.u64(), oracle_validity_length_ms: bcs.u64(), last_queue_override_ms: bcs.u64(), guardian_queue_id: ID.bcs, existing_oracles: Table.bcs, fee_types: bcs.vector(TypeName.bcs), version: bcs.u8()

}) };

 static fromFields( fields: Record<string, any> ): Queue { return Queue.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), queueKey: decodeFromFields(reified.vector("u8"), fields.queue_key), authority: decodeFromFields("address", fields.authority), name: decodeFromFields(String.reified(), fields.name), fee: decodeFromFields("u64", fields.fee), feeRecipient: decodeFromFields("address", fields.fee_recipient), minAttestations: decodeFromFields("u64", fields.min_attestations), oracleValidityLengthMs: decodeFromFields("u64", fields.oracle_validity_length_ms), lastQueueOverrideMs: decodeFromFields("u64", fields.last_queue_override_ms), guardianQueueId: decodeFromFields(ID.reified(), fields.guardian_queue_id), existingOracles: decodeFromFields(Table.reified(reified.phantom(reified.vector("u8")), reified.phantom(ExistingOracle.reified())), fields.existing_oracles), feeTypes: decodeFromFields(reified.vector(TypeName.reified()), fields.fee_types), version: decodeFromFields("u8", fields.version) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Queue { if (!isQueue(item.type)) { throw new Error("not a Queue type");

 }

 return Queue.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), queueKey: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.queue_key), authority: decodeFromFieldsWithTypes("address", item.fields.authority), name: decodeFromFieldsWithTypes(String.reified(), item.fields.name), fee: decodeFromFieldsWithTypes("u64", item.fields.fee), feeRecipient: decodeFromFieldsWithTypes("address", item.fields.fee_recipient), minAttestations: decodeFromFieldsWithTypes("u64", item.fields.min_attestations), oracleValidityLengthMs: decodeFromFieldsWithTypes("u64", item.fields.oracle_validity_length_ms), lastQueueOverrideMs: decodeFromFieldsWithTypes("u64", item.fields.last_queue_override_ms), guardianQueueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.guardian_queue_id), existingOracles: decodeFromFieldsWithTypes(Table.reified(reified.phantom(reified.vector("u8")), reified.phantom(ExistingOracle.reified())), item.fields.existing_oracles), feeTypes: decodeFromFieldsWithTypes(reified.vector(TypeName.reified()), item.fields.fee_types), version: decodeFromFieldsWithTypes("u8", item.fields.version) } ) }

...
export class AggregatorUpdated implements StructClass { __StructClass = true as const;
 ...
 aggregator_id: ID.bcs, oracle_id: ID.bcs, value: Decimal.bcs, timestamp_ms: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): AggregatorUpdated { return AggregatorUpdated.reified( ).new( { aggregatorId: decodeFromFields(ID.reified(), fields.aggregator_id), oracleId: decodeFromFields(ID.reified(), fields.oracle_id), value: decodeFromFields(Decimal.reified(), fields.value), timestampMs: decodeFromFields("u64", fields.timestamp_ms) } ) }
 ...
 return AggregatorUpdated.reified( ).new( { aggregatorId: decodeFromFieldsWithTypes(ID.reified(), item.fields.aggregator_id), oracleId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_id), value: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.value), timestampMs: decodeFromFieldsWithTypes("u64", item.fields.timestamp_ms) } ) }

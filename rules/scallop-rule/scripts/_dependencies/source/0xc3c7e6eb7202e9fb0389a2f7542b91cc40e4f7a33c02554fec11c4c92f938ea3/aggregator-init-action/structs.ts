...
export class AggregatorCreated implements StructClass { __StructClass = true as const;
 ...
 aggregator_id: ID.bcs, name: String.bcs

}) };

 static fromFields( fields: Record<string, any> ): AggregatorCreated { return AggregatorCreated.reified( ).new( { aggregatorId: decodeFromFields(ID.reified(), fields.aggregator_id), name: decodeFromFields(String.reified(), fields.name) } ) }
 ...
 return AggregatorCreated.reified( ).new( { aggregatorId: decodeFromFieldsWithTypes(ID.reified(), item.fields.aggregator_id), name: decodeFromFieldsWithTypes(String.reified(), item.fields.name) } ) }

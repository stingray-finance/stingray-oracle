...
export class GuardianQueueIdSet implements StructClass { __StructClass = true as const;
 ...
 old_guardian_queue_id: ID.bcs, guardian_queue_id: ID.bcs

}) };

 static fromFields( fields: Record<string, any> ): GuardianQueueIdSet { return GuardianQueueIdSet.reified( ).new( { oldGuardianQueueId: decodeFromFields(ID.reified(), fields.old_guardian_queue_id), guardianQueueId: decodeFromFields(ID.reified(), fields.guardian_queue_id) } ) }
 ...
 return GuardianQueueIdSet.reified( ).new( { oldGuardianQueueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.old_guardian_queue_id), guardianQueueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.guardian_queue_id) } ) }

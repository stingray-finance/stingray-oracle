...
export function registerClasses(loader: StructClassLoader) { loader.register(priceFeed.PriceFeed);
loader.register(priceUpdatePolicy.PriceUpdatePolicy);
loader.register(priceUpdatePolicy.PriceUpdatePolicyCap);
loader.register(priceUpdatePolicy.PriceUpdatePolicyRulesKey);

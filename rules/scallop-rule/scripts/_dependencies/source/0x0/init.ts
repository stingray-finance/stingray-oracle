...
import * as scoinRule from "./scoin-rule/structs";
...
loader.register(scoinRule.Config);
loader.register(scoinRule.AdminCap);
loader.register(scoinRule.Rule);
loader.register(scoinRule.SCoinPair);
 }

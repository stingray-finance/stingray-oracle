...
export function isObjectTable(type: string): boolean { type = compressSuiType(type); return type.startsWith(`${PKG_V37}::object_table::ObjectTable` + '<'); }

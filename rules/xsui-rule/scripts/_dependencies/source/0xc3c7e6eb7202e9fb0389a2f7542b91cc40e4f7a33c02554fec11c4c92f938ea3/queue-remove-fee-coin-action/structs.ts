...
export class QueueFeeTypeRemoved implements StructClass { __StructClass = true as const;
 ...
 queue_id: ID.bcs, fee_type: TypeName.bcs

}) };

 static fromFields( fields: Record<string, any> ): QueueFeeTypeRemoved { return QueueFeeTypeRemoved.reified( ).new( { queueId: decodeFromFields(ID.reified(), fields.queue_id), feeType: decodeFromFields(TypeName.reified(), fields.fee_type) } ) }
 ...
 return QueueFeeTypeRemoved.reified( ).new( { queueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.queue_id), feeType: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.fee_type) } ) }

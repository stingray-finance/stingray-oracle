...
export class AggregatorConfigsUpdated implements StructClass { __StructClass = true as const;
 ...
 aggregator_id: ID.bcs, feed_hash: bcs.vector(bcs.u8()), min_sample_size: bcs.u64(), max_staleness_seconds: bcs.u64(), max_variance: bcs.u64(), min_responses: bcs.u32()

}) };

 static fromFields( fields: Record<string, any> ): AggregatorConfigsUpdated { return AggregatorConfigsUpdated.reified( ).new( { aggregatorId: decodeFromFields(ID.reified(), fields.aggregator_id), feedHash: decodeFromFields(reified.vector("u8"), fields.feed_hash), minSampleSize: decodeFromFields("u64", fields.min_sample_size), maxStalenessSeconds: decodeFromFields("u64", fields.max_staleness_seconds), maxVariance: decodeFromFields("u64", fields.max_variance), minResponses: decodeFromFields("u32", fields.min_responses) } ) }
 ...
 return AggregatorConfigsUpdated.reified( ).new( { aggregatorId: decodeFromFieldsWithTypes(ID.reified(), item.fields.aggregator_id), feedHash: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.feed_hash), minSampleSize: decodeFromFieldsWithTypes("u64", item.fields.min_sample_size), maxStalenessSeconds: decodeFromFieldsWithTypes("u64", item.fields.max_staleness_seconds), maxVariance: decodeFromFieldsWithTypes("u64", item.fields.max_variance), minResponses: decodeFromFieldsWithTypes("u32", item.fields.min_responses) } ) }

...
export class Aggregator implements StructClass { __StructClass = true as const;
 ...
 id: UID.bcs, queue: ID.bcs, created_at_ms: bcs.u64(), name: String.bcs, authority: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), feed_hash: bcs.vector(bcs.u8()), min_sample_size: bcs.u64(), max_staleness_seconds: bcs.u64(), max_variance: bcs.u64(), min_responses: bcs.u32(), current_result: CurrentResult.bcs, update_state: UpdateState.bcs, version: bcs.u8()

}) };

 static fromFields( fields: Record<string, any> ): Aggregator { return Aggregator.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), queue: decodeFromFields(ID.reified(), fields.queue), createdAtMs: decodeFromFields("u64", fields.created_at_ms), name: decodeFromFields(String.reified(), fields.name), authority: decodeFromFields("address", fields.authority), feedHash: decodeFromFields(reified.vector("u8"), fields.feed_hash), minSampleSize: decodeFromFields("u64", fields.min_sample_size), maxStalenessSeconds: decodeFromFields("u64", fields.max_staleness_seconds), maxVariance: decodeFromFields("u64", fields.max_variance), minResponses: decodeFromFields("u32", fields.min_responses), currentResult: decodeFromFields(CurrentResult.reified(), fields.current_result), updateState: decodeFromFields(UpdateState.reified(), fields.update_state), version: decodeFromFields("u8", fields.version) } ) }
 ...
 return Aggregator.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), queue: decodeFromFieldsWithTypes(ID.reified(), item.fields.queue), createdAtMs: decodeFromFieldsWithTypes("u64", item.fields.created_at_ms), name: decodeFromFieldsWithTypes(String.reified(), item.fields.name), authority: decodeFromFieldsWithTypes("address", item.fields.authority), feedHash: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.feed_hash), minSampleSize: decodeFromFieldsWithTypes("u64", item.fields.min_sample_size), maxStalenessSeconds: decodeFromFieldsWithTypes("u64", item.fields.max_staleness_seconds), maxVariance: decodeFromFieldsWithTypes("u64", item.fields.max_variance), minResponses: decodeFromFieldsWithTypes("u32", item.fields.min_responses), currentResult: decodeFromFieldsWithTypes(CurrentResult.reified(), item.fields.current_result), updateState: decodeFromFieldsWithTypes(UpdateState.reified(), item.fields.update_state), version: decodeFromFieldsWithTypes("u8", item.fields.version) } ) }
...
export class CurrentResult implements StructClass { __StructClass = true as const;
 ...
 result: Decimal.bcs, timestamp_ms: bcs.u64(), min_timestamp_ms: bcs.u64(), max_timestamp_ms: bcs.u64(), min_result: Decimal.bcs, max_result: Decimal.bcs, stdev: Decimal.bcs, range: Decimal.bcs, mean: Decimal.bcs

}) };

 static fromFields( fields: Record<string, any> ): CurrentResult { return CurrentResult.reified( ).new( { result: decodeFromFields(Decimal.reified(), fields.result), timestampMs: decodeFromFields("u64", fields.timestamp_ms), minTimestampMs: decodeFromFields("u64", fields.min_timestamp_ms), maxTimestampMs: decodeFromFields("u64", fields.max_timestamp_ms), minResult: decodeFromFields(Decimal.reified(), fields.min_result), maxResult: decodeFromFields(Decimal.reified(), fields.max_result), stdev: decodeFromFields(Decimal.reified(), fields.stdev), range: decodeFromFields(Decimal.reified(), fields.range), mean: decodeFromFields(Decimal.reified(), fields.mean) } ) }
 ...
 return CurrentResult.reified( ).new( { result: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.result), timestampMs: decodeFromFieldsWithTypes("u64", item.fields.timestamp_ms), minTimestampMs: decodeFromFieldsWithTypes("u64", item.fields.min_timestamp_ms), maxTimestampMs: decodeFromFieldsWithTypes("u64", item.fields.max_timestamp_ms), minResult: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.min_result), maxResult: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.max_result), stdev: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.stdev), range: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.range), mean: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.mean) } ) }
...
export class Update implements StructClass { __StructClass = true as const;
 ...
 result: Decimal.bcs, timestamp_ms: bcs.u64(), oracle: ID.bcs

}) };

 static fromFields( fields: Record<string, any> ): Update { return Update.reified( ).new( { result: decodeFromFields(Decimal.reified(), fields.result), timestampMs: decodeFromFields("u64", fields.timestamp_ms), oracle: decodeFromFields(ID.reified(), fields.oracle) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): Update { if (!isUpdate(item.type)) { throw new Error("not a Update type");

 }

 return Update.reified( ).new( { result: decodeFromFieldsWithTypes(Decimal.reified(), item.fields.result), timestampMs: decodeFromFieldsWithTypes("u64", item.fields.timestamp_ms), oracle: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle) } ) }
...
export class UpdateState implements StructClass { __StructClass = true as const;
 ...
 results: bcs.vector(Update.bcs), curr_idx: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): UpdateState { return UpdateState.reified( ).new( { results: decodeFromFields(reified.vector(Update.reified()), fields.results), currIdx: decodeFromFields("u64", fields.curr_idx) } ) }
 ...
 return UpdateState.reified( ).new( { results: decodeFromFieldsWithTypes(reified.vector(Update.reified()), item.fields.results), currIdx: decodeFromFieldsWithTypes("u64", item.fields.curr_idx) } ) }

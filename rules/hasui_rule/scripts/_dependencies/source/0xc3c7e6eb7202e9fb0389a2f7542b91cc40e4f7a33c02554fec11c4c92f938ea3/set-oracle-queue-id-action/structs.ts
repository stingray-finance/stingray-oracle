...
export class OracleQueueIdSet implements StructClass { __StructClass = true as const;
 ...
 old_oracle_queue_id: ID.bcs, oracle_queue_id: ID.bcs

}) };

 static fromFields( fields: Record<string, any> ): OracleQueueIdSet { return OracleQueueIdSet.reified( ).new( { oldOracleQueueId: decodeFromFields(ID.reified(), fields.old_oracle_queue_id), oracleQueueId: decodeFromFields(ID.reified(), fields.oracle_queue_id) } ) }
 ...
 return OracleQueueIdSet.reified( ).new( { oldOracleQueueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.old_oracle_queue_id), oracleQueueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_queue_id) } ) }

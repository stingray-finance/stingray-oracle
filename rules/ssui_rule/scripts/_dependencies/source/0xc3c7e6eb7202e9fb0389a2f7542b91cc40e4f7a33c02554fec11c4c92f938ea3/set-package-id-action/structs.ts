...
export class OnDemandPackageIdSet implements StructClass { __StructClass = true as const;
 ...
 old_on_demand_package_id: ID.bcs, on_demand_package_id: ID.bcs

}) };

 static fromFields( fields: Record<string, any> ): OnDemandPackageIdSet { return OnDemandPackageIdSet.reified( ).new( { oldOnDemandPackageId: decodeFromFields(ID.reified(), fields.old_on_demand_package_id), onDemandPackageId: decodeFromFields(ID.reified(), fields.on_demand_package_id) } ) }
 ...
 return OnDemandPackageIdSet.reified( ).new( { oldOnDemandPackageId: decodeFromFieldsWithTypes(ID.reified(), item.fields.old_on_demand_package_id), onDemandPackageId: decodeFromFieldsWithTypes(ID.reified(), item.fields.on_demand_package_id) } ) }

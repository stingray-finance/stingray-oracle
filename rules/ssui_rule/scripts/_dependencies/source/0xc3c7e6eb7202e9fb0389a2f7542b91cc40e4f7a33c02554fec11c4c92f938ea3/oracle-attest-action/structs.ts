...
export class AttestationCreated implements StructClass { __StructClass = true as const;
 ...
 oracle_id: ID.bcs, guardian_id: ID.bcs, secp256k1_key: bcs.vector(bcs.u8()), timestamp_ms: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): AttestationCreated { return AttestationCreated.reified( ).new( { oracleId: decodeFromFields(ID.reified(), fields.oracle_id), guardianId: decodeFromFields(ID.reified(), fields.guardian_id), secp256K1Key: decodeFromFields(reified.vector("u8"), fields.secp256k1_key), timestampMs: decodeFromFields("u64", fields.timestamp_ms) } ) }
 ...
 return AttestationCreated.reified( ).new( { oracleId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_id), guardianId: decodeFromFieldsWithTypes(ID.reified(), item.fields.guardian_id), secp256K1Key: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.secp256k1_key), timestampMs: decodeFromFieldsWithTypes("u64", item.fields.timestamp_ms) } ) }
...
export class AttestationResolved implements StructClass { __StructClass = true as const;
 ...
 oracle_id: ID.bcs, secp256k1_key: bcs.vector(bcs.u8()), timestamp_ms: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): AttestationResolved { return AttestationResolved.reified( ).new( { oracleId: decodeFromFields(ID.reified(), fields.oracle_id), secp256K1Key: decodeFromFields(reified.vector("u8"), fields.secp256k1_key), timestampMs: decodeFromFields("u64", fields.timestamp_ms) } ) }
 ...
 return AttestationResolved.reified( ).new( { oracleId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_id), secp256K1Key: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.secp256k1_key), timestampMs: decodeFromFieldsWithTypes("u64", item.fields.timestamp_ms) } ) }

...
export class QueueFeeTypeAdded implements StructClass { __StructClass = true as const;
 ...
 static fromFields( fields: Record<string, any> ): QueueFeeTypeAdded { return QueueFeeTypeAdded.reified( ).new( { queueId: decodeFromFields(ID.reified(), fields.queue_id), feeType: decodeFromFields(TypeName.reified(), fields.fee_type) } ) }
 ...
 return QueueFeeTypeAdded.reified( ).new( { queueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.queue_id), feeType: decodeFromFieldsWithTypes(TypeName.reified(), item.fields.fee_type) } ) }

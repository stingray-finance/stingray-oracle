...
export class QueueOracleOverride implements StructClass { __StructClass = true as const;
 ...
 queue_id: ID.bcs, oracle_id: ID.bcs, secp256k1_key: bcs.vector(bcs.u8()), mr_enclave: bcs.vector(bcs.u8()), expiration_time_ms: bcs.u64()

}) };

 static fromFields( fields: Record<string, any> ): QueueOracleOverride { return QueueOracleOverride.reified( ).new( { queueId: decodeFromFields(ID.reified(), fields.queue_id), oracleId: decodeFromFields(ID.reified(), fields.oracle_id), secp256K1Key: decodeFromFields(reified.vector("u8"), fields.secp256k1_key), mrEnclave: decodeFromFields(reified.vector("u8"), fields.mr_enclave), expirationTimeMs: decodeFromFields("u64", fields.expiration_time_ms) } ) }
 ...
 return QueueOracleOverride.reified( ).new( { queueId: decodeFromFieldsWithTypes(ID.reified(), item.fields.queue_id), oracleId: decodeFromFieldsWithTypes(ID.reified(), item.fields.oracle_id), secp256K1Key: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.secp256k1_key), mrEnclave: decodeFromFieldsWithTypes(reified.vector("u8"), item.fields.mr_enclave), expirationTimeMs: decodeFromFieldsWithTypes("u64", item.fields.expiration_time_ms) } ) }
